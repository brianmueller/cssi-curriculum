...
|Think-Pair-Share|Think-pair-share (TPS) is a collaborative learning strategy in which students work together to solve a problem or answer a question about an assigned reading. This technique requires students to (1)think individually about a topic or answer to a question; and (2) pair with classmates and discuss their thoughts
(3) share students share out to the class what was discussed| Take a moment to think about situations where it would make sense to use a file script vs the interactive mode. When I say go, pair with a partner and together come up with at least 2 scenarios where you might want to use a file, and 2 where you might want to use the interactive mode. You will share your reasons in each scenario.|https://www.youtube.com/watch?v=KAPyC-NrUS8 |
