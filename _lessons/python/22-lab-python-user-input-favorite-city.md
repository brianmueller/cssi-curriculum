...
##  User Input Mini App
Let's build a simple input/output app. The main What You Will Learn is to create an application that _takes in user input, does something with that input, and then prints out an output_.
